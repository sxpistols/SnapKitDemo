...
//            make.centerY.equalTo(self)
    ...
    func setupTitle() {
        ...
        lblTitle.snp.makeConstraints { (make) in
            make.edges.equalTo(viewTop).inset(UIEdgeInsets.init(top: 0.0, left: 16.0, bottom: 0.0, right: 0.0))
        }
    }
    ...
    func setupTextfields() {
        ...
        txtEmail.snp.makeConstraints { (make) in
            make.top.equalTo(viewTop.snp.bottom).offset(16)
            make.left.equalTo(viewContainer).offset(20)
            make.right.equalTo(viewContainer).offset(-20)
            make.height.equalTo(textfieldHeight)
        }
